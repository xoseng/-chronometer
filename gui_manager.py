...
def start_chronometer():
    ...
    if my_chrono.max_time == my_chrono.seconds:
        my_gui.time.config(fg="red")
        my_gui.time['text'] = "C'est fini"
        stop_chronometer()
    else:
        my_gui.time['text'] = display_time_in_mm_ss(my_chrono.seconds, my_chrono.max_time)
